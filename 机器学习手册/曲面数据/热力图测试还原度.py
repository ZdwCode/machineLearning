...
path = r'G:\mogodar_case\case43\reducion_copy.xlsx'
...
heatmap = plt.imshow(temperature_matrix*100, cmap='RdYlGn_r', aspect='auto', origin='lower',interpolation='bilinear')

# 添加等温线
contours = plt.contour(temperature_matrix*100, colors='black', linewidths=0.5, linestyles='solid',levels=[0,30,60,90])
...
# 添加标题和轴标签
ax = plt.gca()
plt.text(1.03,0.97,'Reduction (%)',transform=ax.transAxes,fontsize=12)
x = []
...
plt.ylim(0,117)
# plt.title('Degree of reduction (%)',fontdict=font2)
# 显示图例
# top=0.98,
# bottom=0.065,
# left=0.165,
...
# path = r'G:\mogodar_case\case50\reducion_copy.xlsx'
save_path = r'G:\poststudy\2024-04\论文修改\还原度\case_9.png'
