...
hyperparemeters = dict(optimizer=optimizers,batch_size=batches,epochs=epochs)

grid = GridSearchCV(estimator=neural_network,param_grid=hyperparemeters)

gird_result = grid.fit(features,targets)
print(gird_result)